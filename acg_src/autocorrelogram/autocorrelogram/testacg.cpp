...
////////////////////////////////////////////////////////////////////////
  ...
  // Read wav data
  char wave_full_path[] = "D:\\Desktop\\work\\forrong\\acg_src\\autocorrelogram\\autocorrelogram\\test.wav";
  char wave_output_path[]= "D:\\Desktop\\work\\forrong\\acg_src\\autocorrelogram\\autocorrelogram\\test.acg";

  char wave_source_path[] = "test.wav";
  char wave_out_path[] = "test.acg";

  AudioWav wav;
  if (wav.read(wave_source_path) < 1)
    return 0;
